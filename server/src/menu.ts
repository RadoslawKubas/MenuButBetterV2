...
export const SYSTEM = [
  ...
  "",
  "Dla pola `photo_query` podaj KRÓTKĄ, GENERYCZNĄ angielską nazwę dania do wyszukania",
  "zdjęcia w internecie — opisz CZYM danie jest (typ potrawy), a nie markową/lokalną nazwą",
  "z menu. To poprawia trafianie w zdjęcie, gdy szukamy ogólnie (bez konkretnej restauracji).",
  "",
